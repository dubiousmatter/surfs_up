...
# Create a new Flask App Instance (define the Flask app)
app = Flask(__name__)
...
# Create preceipitation analysis route
@app.route("/api/v1.0/precipitation")

# Create the precipitation function, calculate the date one year ago and get the precipitation for the previous year
def precipitation():
